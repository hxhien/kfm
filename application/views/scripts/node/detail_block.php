			...
			<table cellspacing="0" cellpadding="0" width="98%">
				...
				<tr>
					<td style="border-left: 1px solid rgb(128, 128, 128); border-right: 1px solid rgb(128, 128, 128); border-bottom: 1px solid rgb(128, 128, 128);">
						...
						<div style="padding: 5px;">
						<b>Content</b>
						<textarea id="body_en" name="body_en" style="width:610px;height:300px"><?php echo $this->body_en?></textarea>
						</div>
                    </td>
            	</tr>
			</tbody></table>
			...
			<table cellspacing="0" cellpadding="0" width="98%">
				...
				<tr>
					<td style="border-left: 1px solid rgb(128, 128, 128); border-right: 1px solid rgb(128, 128, 128); border-bottom: 1px solid rgb(128, 128, 128);">
						...
						<div style="padding: 5px;">
						<b>Content</b>
						<textarea id="body_kr" name="body_kr" style="width:610px;height:300px"><?php echo $this->body_kr?></textarea>
						</div>
                    </td>
            	</tr>
			</tbody></table>
			...
			<table cellspacing="0" cellpadding="0" width="98%">
				...
				<tr>
					<td style="border-left: 1px solid rgb(128, 128, 128); border-right: 1px solid rgb(128, 128, 128); border-bottom: 1px solid rgb(128, 128, 128);">
						...
						<div style="padding: 5px;">
						<b>Content</b>
						<textarea id="body_vi" name="body_vi" style="width:610px;height:300px"><?php echo $this->body_vi?></textarea>
						</div>
                    </td>
            	</tr>
			</tbody></table>
