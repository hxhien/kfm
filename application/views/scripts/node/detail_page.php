			...
			<table cellspacing="0" cellpadding="0" width="98%">
				...
				<tr>
					<td style="border-left: 1px solid rgb(128, 128, 128); border-right: 1px solid rgb(128, 128, 128); border-bottom: 1px solid rgb(128, 128, 128);">
						...
						<div style="padding: 5px;">
						<textarea id="body_en" name="body_en"><?php echo $this->body_en?></textarea>
						</div>
                    </td>
            	</tr>
			</tbody></table>
			...
			<table cellspacing="0" cellpadding="0" width="98%">
				...
				<tr>
					<td style="border-left: 1px solid rgb(128, 128, 128); border-right: 1px solid rgb(128, 128, 128); border-bottom: 1px solid rgb(128, 128, 128);">
						...
						<div style="padding: 5px;">
						<textarea id="body_kr" name="body_kr"><?php echo $this->body_kr?></textarea>
						</div>
                    </td>
            	</tr>
			</tbody></table>
			...
			<table cellspacing="0" cellpadding="0" width="98%">
				...
				<tr>
					<td style="border-left: 1px solid rgb(128, 128, 128); border-right: 1px solid rgb(128, 128, 128); border-bottom: 1px solid rgb(128, 128, 128);">
						...
						<div style="padding: 5px;">
						<textarea id="body_vi" name="body_vi"><?php echo $this->body_vi?></textarea>
						</div>
                    </td>
            	</tr>
			</tbody></table>
